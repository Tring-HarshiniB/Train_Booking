...
public class FoodMenu extends TrainDetails{
    ...
    FoodMenu(String name, int price, double from, double till) {
        this.name = name;
        this.price = price;
        this.from = from;
        this.till = till;
    ...
    static ArrayList<FoodMenu> breakFast = new ArrayList<>();
    static ArrayList<FoodMenu> lunch = new ArrayList<>();
    static ArrayList<FoodMenu> dinner = new ArrayList<>();
    ...
    public void breakfast() {
        ...
        System.out.print(" \n Availabe Till : ");
        till = sc.nextDouble();
        breakFast.add(new FoodMenu(name, price, from, till));
    }
    ...
    public void lunch() {
        ...
        System.out.print(" \n Availabe Till : ");
        till = sc.nextDouble();
        lunch.add(new FoodMenu(name, price, from, till));
    }
    ...
    public void dinner() {
        ...
        System.out.print(" \n Availabe Till : ");
        till = sc.nextDouble();
        dinner.add(new FoodMenu(name, price, from, till));
    }
